...
class ProductPricelist(models.Model):
    ...
    # Override function to add the following changes:
    #   - Detect new max_quantity field
    #   - Get price 0 when a rule is not within qtys
    def _compute_price_rule(self, products_qty_partner, date=False, uom_id=False):
        ...
        for product, qty, partner in products_qty_partner:
            ...
            for rule in items:
                ...
                #     continue
                if qty_in_product_uom < min_quantity or qty_in_product_uom > max_quantity:
                    continue
